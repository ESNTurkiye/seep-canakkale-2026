...
SEEP Çanakkale 2026 — ESN Türkiye.

## Agent skills

### Issue tracker

Issues live as GitHub issues in `ESNTurkiye/seep-canakkale-2026`, managed with the `gh` CLI. See `docs/agents/issue-tracker.md`.
